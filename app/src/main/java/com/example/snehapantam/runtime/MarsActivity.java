...
public class MarsActivity extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = "MarsActivity";
    ...
    LatLng mars_book= new LatLng(34.18263197, -117.32396632);
    ...
    private void polylinemethod() {
        ...
        polylines.put("polylinesneha",mMap.addPolyline(polylineOptions.add(points.get(0),mars_book)));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog.Builder alertdialog = new AlertDialog.Builder(MarsActivity.this);
                alertdialog.setTitle("Thank you for using our App!");

                alertdialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        final Intent intent = new Intent(MarsActivity.this, MainActivity.class);
