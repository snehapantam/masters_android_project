...
public class VenusActivity extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = "VenusActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog.Builder alertdialog = new AlertDialog.Builder(VenusActivity.this);
                alertdialog.setTitle("Thank you for using our App!");

                alertdialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        final Intent intent = new Intent(VenusActivity.this, MainActivity.class);
