...
public class JupiterActivity extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = "JupiterActivity";
    ...
    public IALocationListener mListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(final IALocation location) {
            ...
            Marker mMarker1 = mMap.addMarker(new MarkerOptions().position(jupiter_book).title("Jupiter").snippet("Row:74 Fifth shelf ")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                AlertDialog.Builder alertdialog = new AlertDialog.Builder(JupiterActivity.this);
                alertdialog.setTitle("Thank you for using our App!");

                alertdialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        final Intent intent = new Intent(JupiterActivity.this, MainActivity.class);
